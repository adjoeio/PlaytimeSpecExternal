Pod::Spec.new do |spec|
  ...
  spec.source       = { :http => "https://releases.adjoe.io/files/playtime/ios/monetize/#{spec.version}/PlaytimeSDK.zip", :type => 'zip' }
  spec.author       = { "adjoe" => "support@adjoe.atlassian.net" }
  spec.platform     = :ios, "13.0"
  spec.swift_version = '6.0'

  spec.ios.preserve_paths = 'PlaytimeSDK.xcframework'
  spec.ios.vendored_frameworks = 'PlaytimeSDK.xcframework'
end
